...
import { ChevronLeft, Shield, Heart, Users, AlertTriangle, Ban, UserCheck, ExternalLink } from 'lucide-react';
import { TopNavBar } from '../components/ui/top-nav-bar';

interface AmigoGuidelinesScreenProps {
  onBack: () => void;
}

export const AmigoGuidelinesScreen = ({ onBack }: AmigoGuidelinesScreenProps) => {
  const guidelines = [
    {
      icon: Heart,
      title: 'Be Respectful',
    ...
    },
    {
      ...
      description: 'Use your verified account responsibly. Build genuine connections through direct messages, groups, and signals.',
      color: '#3B82F6'
    },
    {
      icon: Ban,
      title: 'No Spam or Scams',
      description: 'Don\'t send unwanted promotional content, scams, or fraudulent schemes. Respect others\' time and inbox.',
      color: '#FF6363'
    },
    {
      icon: Users,
      title: 'Respect Privacy',
      description: 'Don\'t share others\' contact information, messages, or personal details without their consent.',
      color: '#9B7BFF'
    },
    {
      icon: AlertTriangle,
      title: 'Report Issues',
      description: 'If you see something inappropriate, report it. Help us keep the Amigo community safe for everyone.',
      color: '#FBBF24'
    },
    {
      icon: Shield,
      title: 'Child Safety',
      description: 'Amigo is for users 13+. Any content exploiting minors will result in immediate action and reporting to authorities.',
      color: '#FF6363'
    },
  ];
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
        ...
        >
          ...
          <p className="text-[14px] text-[#C5C6E3] leading-relaxed max-w-md mx-auto">
            Amigo is built on trust, respect, and authentic connections. Follow these guidelines to create a positive experience for everyone.
          </p>
        </motion.div>
            ...
            <div>
              ...
              <ul className="space-y-1.5">
                <li className="text-[13px] text-[#C5C6E3] flex items-start gap-2">
                  ...
                  <span>Warning from support team</span>
                </li>
                <li className="text-[13px] text-[#C5C6E3] flex items-start gap-2">
                  <span className="text-[#FF6363] mt-0.5">•</span>
                  <span>Temporary account suspension (1-7 days)</span>
                </li>
                <li className="text-[13px] text-[#C5C6E3] flex items-start gap-2">
                  <span className="text-[#FF6363] mt-0.5">•</span>
                  <span>Removal from specific groups or signals</span>
                </li>
                <li className="text-[13px] text-[#C5C6E3] flex items-start gap-2">
                  <span className="text-[#FF6363] mt-0.5">•</span>
                  <span>Permanent account termination (for severe violations)</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        >
          <a
            href="https://www.cryptogram.tech/community-guidelines"
            target="_blank"
