...
const GroupType = ({ navigation }) => {
  ...
  const initialiseGroup = async () => {
    await axios.post(`${basepath}group/create-group`, { groupType: data.title }, {
      headers: {
  ...
  return (
    <SafeAreaView style={styles.container} >
      <View style={styles.top} >
        ...
        <Text style={{ fontSize: 22, fontWeight: "700", color: "white" }} >Group Type</Text>
