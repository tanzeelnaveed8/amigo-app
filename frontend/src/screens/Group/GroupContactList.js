...
const GroupContactList = ({ navigation }) => {
...
const handleUpdateGroup= async()=>{
  await axios.patch(`${basepath}group/update-group`,{groupId:group.groupId,participants:participent},{
    headers: {
    ...
    if (res?.data?.status===200) {
      ...
      dispatch(setGroupParticipent(participent))
      navigation.navigate('Create Group',{selectedUser,participent})
    }
  ...
  return (
    <SafeAreaView style={styles.container} >
      <View style={styles.top} >
        ...
        <View   >
          <Text style={{ textAlign: "center", color: "#fff", fontSize: 18, fontWeight: "600" }}  >New Group</Text>
