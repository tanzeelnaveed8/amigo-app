...
console.log({chanel},'memmmm');
  ...
  const handleAddMember= async ()=>{
    if (addUser.length>0) {
      await axios.patch(`${basepath}chanel/add-member-in-chanel`,
        {
          chanelId:chanel._id,
          userId: addUser
        },
  ...
  return (
    <SafeAreaView style={styles.container} >
      <View style={styles.top} >
        ...
        <View   >
          <Text style={{ textAlign: "center", color: "#fff", fontSize: 18, fontWeight: "600" }}  > Add Members</Text>
      ...
      <TouchableOpacity style={styles.floatingbtn} onPress={()=>handleAddMember()}>
...
export default AddChanelMember