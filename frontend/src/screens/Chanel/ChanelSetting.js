...
const ChanelSetting = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={[styles.container, user.isDarkMode && { backgroundColor: "#0D142E" }]} >
            <View style={styles.top} >
                ...
                <Text style={{ fontSize: 18, fontWeight: "700", color: "white" }} >Signal Settings</Text>
            ...
            <View style={{width:"100%",paddingHorizontal:20,paddingTop:20}} >
                ...
                <View style={styles.setting} >
                    <TouchableOpacity style={styles.setting1} onPress={()=>navigation.navigate('Add Chanel Member')} >
                ...
                <View style={styles.setting} >
                    <TouchableOpacity style={styles.setting1} onPress={()=>navigation.navigate('Chanel Addministrator')} >
